...
urlpatterns = [
    ...
    path('delete-selected-users/', views.DeleteSelectedUsersView.as_view(), name='delete-selected-users'),
    ...
    path('users/import-users/', views.ImportUsersView.as_view(), name='import-users'),                          # Импорт пользователей
